...
public class MatomoViewPage extends ViewPage
{
    ...
    static public String createToken(String address)
    {
        XWikiWebDriver driver = getUtil().getDriver();
            ...
            getUtil().gotoPage(
                address+"/index.php?module=UsersManager&action=addNewToken&idSite=1&period=day&date=2023"
                    + "-09-03");
    ...
    static public void returnToXwiki()
    {
        getUtil().gotoPage("http://localhost:8080/xwiki/bin/view/Main/");
    }
}
